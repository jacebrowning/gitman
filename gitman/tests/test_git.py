...
class TestGit:
    ...
    def test_clone(self, mock_call):
        ...
        assert_calls(mock_call, [
            "git clone --mirror mock.git " + os.path.normpath("cache/mock.reference"),
            "git clone --reference " + os.path.normpath("cache/mock.reference") + " mock.git " + os.path.normpath("mock/path")])
